...
python cogdl/scripts/train.py --task unsupervised_node_classification --dataset usa_airport --model from_numpy --seed 0 --device-id $gpu --hidden-size $hidden_size --emb-path saved/usa_airport.npy
...
python cogdl/scripts/train.py --task unsupervised_node_classification --dataset h-index-top-1 --model from_numpy --seed 0 --device-id $gpu --hidden-size $hidden_size --emb-path saved/h-index-top-1.npy
...
python cogdl/scripts/train.py --task unsupervised_node_classification --dataset h-index-rand-1 --model from_numpy --seed 0 --device-id $gpu --hidden-size $hidden_size --emb-path saved/h-index-rand-1.npy
...
python cogdl/scripts/train.py --task unsupervised_node_classification --dataset h-index-rand20intop200 --model from_numpy --seed 0 --device-id $gpu --hidden-size $hidden_size --emb-path saved/h-index-rand20intop200.npy
...
python cogdl/scripts/train.py --task unsupervised_node_classification --dataset brazil_airport --model from_numpy --seed 0 --device-id $gpu --hidden-size $hidden_size --emb-path saved/brazil_airport.npy
...
python cogdl/scripts/train.py --task unsupervised_node_classification --dataset europe_airport --model from_numpy --seed 0 --device-id $gpu --hidden-size $hidden_size --emb-path saved/europe_airport.npy
